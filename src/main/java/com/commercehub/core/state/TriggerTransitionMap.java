...
//    /** Used to record the results of viability calculations, which can be
//     * expensive
//     * TriggerTransitionKey : Set<State> : Boolean
//     */
//    private Map keyStateViability;

    /**
     * Initializes a new TriggerTransitionMap.
     */
